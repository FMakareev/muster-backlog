...
The public push is the point of no return for history and naming, so it happens once the license, README, hooks, CI and release automation are in place. Everything committed before this becomes permanently public.
